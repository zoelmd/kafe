		 ...
		 <!-- Input addon -->
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title"><?php echo $lang['edit']; ?> <?php echo $lang['job']; ?> <?php echo $lang['invite']; ?></h3>
                </div>
                <div class="box-body">
                 <form role="form" method="post" id="editform"> 
						...
						if ($q1->count()) {
						   ...
						   $x = 1;
	                         ...
	                         if (isset($_POST['details'])) {
                                $selected = (Input::get('freelancerid') === $freelancerid) ? ' selected="selected"' : '';
							  } else {
                                $selected = ($r1->freelancerid === $freelancerid) ? ' selected="selected"' : '';
							  }
							  
							  echo $name .= '<option value = "' . $r1->freelancerid . '" '.$selected.'>' . $r1->name . '</option>';
							  unset($name); 
							  $x++;
						     }
						}
                  ...
                  <div class="form-group">	
				    <label><?php echo $lang['message']; ?></label>
                      <textarea type="text" id="summernote" name="message" class="form-control"><?php
                         if (isset($_POST['details'])) {
							 echo escape(Input::get('message')); 
						  } else {
						  echo escape($job_message); 
						  }
					  ?></textarea>
                  </div>
                  ...
                  <div class="form-group">	
				    <label><?php echo $lang['description']; ?></label>
                      <textarea type="text" id="summernote_1" name="description" class="form-control"><?php
                         if (isset($_POST['details'])) {
