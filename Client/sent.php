                ...
                <div class="box-body">
                  <div class="table-responsive mailbox-messages">
				    ...
				    <?php
                     ...
                     $query = DB::getInstance()->get("message", "*", ["ORDER" => "date_added DESC", 'AND' => ["user_from" => $client->data()->clientid, "active" => 1, "delete_remove" => 0, "disc" => 0]]);
                     if($query->count()) {
						foreach($query->results() as $row) {
							
					    $q1 = DB::getInstance()->get("freelancer", "*", ["freelancerid" => $row->user_to]);
						if ($q1->count()) {
					    ...
					    echo '<td>
					      ...
					      <a onclick="delete_the('.$row->id.', '.$clientid.')" class="btn btn-danger btn-xs" data-toggle="tooltip" title="' . $lang['delete'] . '"><i class="fa fa-trash-o"></i></a></td>';
