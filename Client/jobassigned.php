      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><?php echo $lang['job']; ?> <?php echo $lang['assigned']; ?> <?php echo $lang['list']; ?></li>
          </ol>
        </section>
		 ...
		 <div class="row">	
		 	...
		 	<div class="col-md-12">
                ...
                <div class="box-header">
                  <h3 class="box-title"><?php echo $lang['job']; ?> <?php echo $lang['assigned']; ?> <?php echo $lang['list']; ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr>
					   ...
					   <th><?php echo $lang['estimated']; ?> <?php echo $lang['end']; ?> <?php echo $lang['date']; ?></th>
                    ...
                    <tbody>
				    <?php
                     $query = DB::getInstance()->get("job", "*", ["AND" => ["clientid" => $client->data()->clientid, "invite" => "0", "delete_remove" => 0, "accepted" => 1], "ORDER" => "date_added DESC"]);
                     if($query->count()) {
					    ...
					    if (escape($row->completed) == 1) {
					    echo '<td><span class="label label-success"> ' . $lang['completed'] . ' </span> </td>';
						} else {
