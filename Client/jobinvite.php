		 	...
		 	<div class="col-md-12">
                ...
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
				    <?php
                     $query = DB::getInstance()->get("job", "*", ["AND" => ["clientid" => $client->data()->clientid, "invite" => 1, "delete_remove" => 0], "ORDER" => "date_added DESC"]);
                     if($query->count()) {
					    ...
					    $q2 = DB::getInstance()->get("freelancer", "*", ["freelancerid" => $row->freelancerid]);
						if ($q2->count()) {
					    ...
					    echo '<tr>';
					    echo '<td><a href="../freelancer.php?a=overview&&id='. escape($row->freelancerid) .'">'. escape($name2) .'</a></td>';
					    echo '<td>'.$link.'</a></td>';
					    ...
					    echo '<td>
					      ...
					      '.$delete.'
					       '.$public.'
					      '.$mark.'
					      <a href="viewinvite.php?id=' . escape($row->jobid) . '" class="btn btn-primary btn-xs" data-toggle="tooltip" title="' . $lang['view'] . ' ' . $lang['invite'] . '"><span class="fa fa-eye"></span></a>
					      </td>';
					    echo '</tr>';
						unset($delete);
						unset($public);
