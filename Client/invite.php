		 ...
		 <!-- Input addon -->
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title"><?php echo $lang['invite']; ?>  <strong><?php echo $freelancer_name; ?></strong> <?php echo $lang['to']; ?> <?php echo $lang['a']; ?> <?php echo $lang['job']; ?></h3>
                </div>
                <div class="box-body">
                 <form role="form" method="post" id="addform"> 
                  ...
                  <div class="form-group">	
					...
					<div class="radio">
					  <label><input type="radio" name="job_type" checked="checked" value="Fixed"><?php echo $lang['fixed_price']; ?></label>
					</div>								    
                  </div> 
