	 ...
	 <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1><?php echo $lang['invitation']; ?><small><?php echo $lang['section']; ?></small></h1>
          <ol class="breadcrumb">
            <li><a href="index.php"><i class="fa fa-dashboard"></i> <?php echo $lang['home']; ?></a></li>
            <li class="active"><?php echo $lang['add']; ?> <?php echo $lang['an']; ?> <?php echo $lang['invite']; ?></li>
          </ol>
        </section>
		 ...
		 <!-- Input addon -->
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title"><?php echo $lang['invite']; ?> <?php echo $lang['freelancer']; ?> <?php echo $lang['to']; ?> <?php echo $lang['a']; ?> <?php echo $lang['job']; ?></h3>
                </div>
                <div class="box-body">
                 <form role="form" method="post" id="addform"> 
                  	
                  <div class="form-group">	
				    <label><?php echo $lang['freelancer']; ?></label>
                   <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-pencil-square"></i></span>
					<select name="freelancerid" type="text" class="form-control">
					 <?php
					  $q1 = DB::getInstance()->get("freelancer", "*", ["AND" => ["active" => 1, "delete_remove" => 0]]);
						if ($q1->count()) {
						   $name = '';
						   $x = 1;
							 foreach ($q1->results() as $r1) {

							  echo $name .= '<option value = "' . $r1->freelancerid . '" >' . $r1->name . '</option>';
							  unset($name); 
							  $x++;
						     }
						}
                  ...
                  <div class="form-group">	
				    <label><?php echo $lang['message']; ?></label>
                      <textarea type="text" id="summernote" name="message" class="form-control"></textarea>
                  </div>
                  
                  <div class="form-group">	
				    <label><?php echo $lang['job']; ?> <?php echo $lang['title']; ?></label>
                   <div class="input-group">
                  ...
                  <div class="form-group">	
				    <label><?php echo $lang['job']; ?> <?php echo $lang['description']; ?></label>
                      <textarea type="text" id="summernote_1" name="description" class="form-control"></textarea>
                  </div>
