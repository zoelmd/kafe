...
if (Input::exists()) {
 if(Token::check(Input::get('token'))){
    ...
    if (!$validation->fails()) {
		...
		//Update Client
		$clientUpdate = DB::getInstance()->update('client',[
         ...
         if(move_uploaded_file($tmp, $path.$actual_image_name))
	      {
	       ...
	       if ($imagelocation !== 'uploads/default.png') {
				...
				$freelancerUpdate = DB::getInstance()->update('client',[
...
if (Input::exists()) {
  if (Token::check(Input::get('token'))) {
    ...
    if (!$validation->fails()) {
		...
		if (Hash::make(Input::get('password_current'), $client_salt) !== $client_password) {
			$passError = true;
		} else {
		  $salt = Hash::salt(32);			
		  
		  $passwordUpdate = DB::getInstance()->update('client',[
	 ...
	 <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1><?php echo $lang['client']; ?><small><?php echo $lang['section']; ?></small></h1>
          <ol class="breadcrumb">
            <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> <?php echo $lang['home']; ?></a></li>
            <li class="active"><?php echo $lang['edit']; ?> <?php echo $lang['client']; ?></li>
          </ol>
        </section>
        ...
        <section class="content">	 	
	     ...
	     <?php if(isset($hasError)) { //If errors are found ?>
          ...
          <div class="col-lg-4">
	         ...
	         <a href="editclient.php?a=data&id=<?php echo $clientid ?>" class="list-group-item<?php echo $selected; ?>">
	          <em class="fa fa-fw fa-user-md text-white"></em>&nbsp;&nbsp;&nbsp;<?php echo $lang['client']; ?> <?php echo $lang['details']; ?>
			 </a>
	         <a href="editclient.php?a=image&id=<?php echo $clientid ?>" class="list-group-item<?php echo $image; ?>">
	          <em class="fa fa-fw fa-image text-white"></em>&nbsp;&nbsp;&nbsp;<?php echo $lang['client']; ?> <?php echo $lang['image']; ?>
			 </a>
	         <a href="editclient.php?a=password&id=<?php echo $clientid ?>" class="list-group-item<?php echo $active; ?>">
		 ...
		 <!-- Input addon -->
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title"><?php echo $lang['edit']; ?> <?php echo $lang['client']; ?> <?php echo $lang['details']; ?></h3>
                </div>
                <div class="box-body">
                 <form role="form" method="post" id="editform"> 
                  <div class="form-group">	
                   <div class="input-group">
                    ...
                    <p class="help-block"><?php echo $lang['client']; ?> <?php echo $lang['name']; ?></p>
                  </div>
                  <div class="form-group">	
                   <div class="input-group">
                    ...
                    <p class="help-block"><?php echo $lang['client']; ?> <?php echo $lang['email']; ?></p>
                  </div>
                  <div class="form-group">	
                   <div class="input-group">
                    ...
                    <p class="help-block"><?php echo $lang['client']; ?> <?php echo $lang['phone']; ?></p>
                  </div>
                  <div class="form-group">	
                   <div class="input-group">
                    ...
                    <p class="help-block"><?php echo $lang['client']; ?> <?php echo $lang['username']; ?></p>
                  </div>      
		 ...
		 <?php elseif (Input::get('a') == 'image') : ?>
                ...
                <form role="form" method="post" enctype="multipart/form-data">
                  <input type="hidden" name="imagelocation" class="form-control" value="<?php echo escape($client_imagelocation); ?>"/>
                  <div class="box-body">
                    <div class="form-group">
					 <div class="image text-center">
					  ...
					  echo escape($client_imagelocation); 
