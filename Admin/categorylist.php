		 ...
		 <div class="row">	
		 	<div class="col-md-12">
                ...
                <div class="box-header">
                  <h3 class="box-title"><?php echo $lang['category']; ?> <?php echo $lang['list']; ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr>
					   ...
					   <th><?php echo $lang['sub']; ?> <?php echo $lang['categories']; ?></th>
                    ...
                    <tbody>
				    <?php
                     $query = DB::getInstance()->get("category", "*", ["active" => 1, 'AND' => ["delete_remove" => 0]]);
                     if($query->count()) {
					    ...
					    echo '<tr>';
					    echo '<td class="text-center"><i class="fa '. $row->icon .'"></i></td>';
					    echo '<td>'. escape($row->name) .'</td>';
					    echo '<td>'. escape($row->sub_category) .'</td>';
					    ...
					    echo '<td>
					      '.$mark.'
					      <a href="editcategory.php?id=' . escape($row->id) . '" class="btn btn-success btn-xs" data-toggle="tooltip" title="' . $lang['edit'] . '"><span class="fa fa-edit"></span></a>
