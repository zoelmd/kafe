        ...
        <!-- Messages: style can be found in dropdown.less-->
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <!-- The user image in the navbar-->
            	<?php // echo $profileimg; ?>
                  <img src="<?php echo escape($admin->data()->imagelocation); ?>" class="user-image" alt="User Image"/>
                ...
                <ul class="dropdown-menu">
						...
						<li class="m_2"><a href="settings.php?a=site"><i class="fa fa-cogs"></i> <?php echo $lang['settings']; ?></a></li>
