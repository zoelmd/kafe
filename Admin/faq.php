 ...
 if(Token::check(Input::get('token'))){
    ...
    if (!$validation->fails()) {
			...
			$siteUpdate = DB::getInstance()->update('settings',[
			    'faq_top_title' => Input::get('faq_top_title')
		    ],[
		    'id' => $sid
		    ]);
      ...
      if(in_array($ext,$valid_formats) && $size<(1920*1280))
	   {
		 ...
		 $path_new = "assets/img/faq/";
		 $newname=$path_new.$image_name;
         $tmp = $_FILES['photoimg']['tmp_name'];
         if(move_uploaded_file($tmp, $path.$actual_image_name))
	      {
	       	$new_bgimage = '../'.$faq_header_img;
			unlink($new_bgimage);
				$sid = Input::get('sid');
				$siteUpdate = DB::getInstance()->update('settings',[
				    'faq_header_img' => $newname
			    ],[
			    'id' => $sid
			    ]);
        ...
        <section class="content">	
		 ...
		 <?php if(isset($imageError)) { //If errors are found ?>
          ...
          <div class="col-lg-4">
	         ...
	         <a href="faq.php?a=details" class="list-group-item<?php echo $selected; ?>">
	          <em class="fa fa-fw fa-info-circle text-white"></em>&nbsp;&nbsp;&nbsp;<?php echo $lang['faq']; ?> <?php echo $lang['details']; ?>
			 </a>
	         <a href="faq.php?a=headerimg" class="list-group-item<?php echo $headerimg; ?>">
	          <em class="fa fa-fw fa-image text-white"></em>&nbsp;&nbsp;&nbsp; <?php echo $lang['faq']; ?> <?php echo $lang['header']; ?> <?php echo $lang['image']; ?> <?php echo $lang['settings']; ?>
			 </a>
	         <a href="faq.php?a=hello" class="list-group-item<?php echo $hello; ?>">
	          <em class="fa fa-fw fa-info-circle text-white"></em>&nbsp;&nbsp;&nbsp;<?php echo $lang['faq']; ?> <?php echo $lang['hello']; ?>
			 </a>
		 ...
		 <!-- Input addon -->
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title"><?php echo $lang['edit']; ?> <?php echo $lang['faq']; ?> <?php echo $lang['page']; ?></h3>
                </div>
                <div class="box-body">
                 <form role="form" method="post"> 
                  ...
                  <div class="form-group">	
                   ...
                   <div class="input-group">
                    ...
                    <textarea type="text" name="faq_top_title" class="form-control" rows="3"><?php
                         if (isset($_POST['site'])) {
							 echo escape(Input::get('faq_top_title')); 
						  } else {
						  echo escape($faq_top_title); 
						  }
					  ?></textarea>
                   </div>
                  </div>
                 ...
                 <form role="form" method="post"> 
                  ...
                  <div class="form-group">	
				    <label><?php echo $lang['details']; ?></label>
                      <textarea type="text" id="summernote" name="faq_hello" class="form-control"><?php
                         if (isset($_POST['hello'])) {
							 echo escape(Input::get('faq_hello')); 
						  } else {
						  echo escape($faq_hello); 
						  }
					  ?></textarea>
                  </div>                   
