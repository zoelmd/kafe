         ...
         if(move_uploaded_file($tmp, $path.$actual_image_name))
	      {
			...
			try{
			   $clientid = uniqueid();	
		       $salt = Hash::salt(32);  
			   $clientInsert = DB::getInstance()->insert('client', array(
				   'clientid' => $clientid,
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><?php echo $lang['add']; ?> <?php echo $lang['client']; ?></li>
          </ol>
        </section>
		 ...
		 <!-- Input addon -->
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title"><?php echo $lang['add']; ?> <?php echo $lang['client']; ?></h3>
                </div>
                <div class="box-body">
                 <form role="form" method="post" id="addform" enctype="multipart/form-data"> 
                  ...
                  <br></br>
                   <div style="position:relative;">
		            ...
		            <?php echo $lang['choose']; ?> <?php echo $lang['client']; ?> <?php echo $lang['image']; ?>...
