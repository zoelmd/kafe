      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><?php echo $lang['edit']; ?> <?php echo $lang['proposal']; ?></li>
          </ol>
        </section>
		 ...
		 <!-- Input addon -->
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title"><?php echo $lang['edit']; ?> <?php echo $lang['proposal']; ?> <?php echo $lang['details']; ?></h3>
                </div>
                <div class="box-body">
				    ...
				    <label><?php echo $lang['description']; ?></label>
                      <textarea type="text" id="summernote" name="description" class="form-control"><?php
                         if (isset($_POST['details'])) {
						  ...
						  echo escape($proposal_description); 
						  }
					  ?></textarea>
                  </div>    
