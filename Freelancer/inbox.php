...
<html lang="en-US" class="no-js">
                ...
                <div class="box-body">
                  <div class="table-responsive mailbox-messages">
				    ...
				    <?php
                     ...
                     $query = DB::getInstance()->get("message", "*", ["ORDER" => "date_added DESC", 'AND' => ["user_to" => $freelancer->data()->freelancerid, "active" => 1, "delete_remove" => 0]]);
                     if($query->count()) {
 ...
 if ($q5->count() === 0) {							
					    ...
					    $q1 = DB::getInstance()->get("client", "*", ["clientid" => $row->user_from]);
						if ($q1->count()) {
					    ...
					    echo '<td>
					      ...
					      <a onclick="delete_not('.$row->id.', '.$freelancerid.')" class="btn btn-danger btn-xs" data-toggle="tooltip" title="' . $lang['delete'] . '"><i class="fa fa-trash-o"></i></a></td>';
