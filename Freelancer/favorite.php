...
<html lang="en-US" class="no-js">
                  ...
                  <div class="table-responsive mailbox-messages">
				    ...
				    <?php
				     $freelancerid = $freelancer->data()->freelancerid;
 					 $query = DB::getInstance()->get("star", ["[>]message" => ["star.messageid" => "id"]], "*", ["ORDER" => "star.date_added DESC", 'AND' => ["star.userid" => $freelancer->data()->freelancerid, "message.delete_remove" => 0]]);
                     if($query->count()) {
 ...
 if ($q5->count() === 0) {							
					    ...
					    $delete = '
					    <a onclick="delete_not('.$r1->id.', '.$freelancerid.')" class="btn btn-danger btn-xs" data-toggle="tooltip" title="' . $lang['delete'] . '"><i class="fa fa-trash-o"></i></a>';
						else:
					    ...
					    $delete = '
					    <a onclick="delete_the('.$r1->id.', '.$freelancerid.')" class="btn btn-danger btn-xs" data-toggle="tooltip" title="' . $lang['delete'] . '"><i class="fa fa-trash-o"></i></a>';
						endif;		
