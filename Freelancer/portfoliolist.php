      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"><?php echo $lang['porfolio']; ?> <?php echo $lang['list']; ?></li>
          </ol>
        </section>
		 ...
		 <div class="row">	
		 	<div class="col-md-12">
                ...
                <div class="box-header">
                  <h3 class="box-title"><?php echo $lang['portfolio']; ?> <?php echo $lang['list']; ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
				    <?php
                     $query = DB::getInstance()->get("portfolio", "*", ['AND' => ["userid" => $freelancer->data()->freelancerid, "delete_remove" => 0]]);
                     if($query->count()) {
					    ...
					    echo '<tr>';
					    echo '<td><a href="viewportfolio.php?id='. escape($row->portfolioid) .'"><img src="'. escape($row->imagelocation) .'" width="50" height="30" /></a></td>';
					    echo '<td><a href="viewportfolio.php?id='. escape($row->portfolioid) .'">'. escape($row->title) .'</a></td>';
					    echo '<td>'. escape($row->date) .'</td>';
					    echo '<td>'. escape($row->client) .'</td>';
					    echo '<td>'. escape($row->website) .'</td>';
					    ...
					    echo '<td>
					      '.$mark.'
					      <a href="viewportfolio.php?id=' . escape($row->portfolioid) . '" class="btn btn-primary btn-xs" data-toggle="tooltip" title="' . $lang['view'] . '"><span class="fa fa-eye"></span></a>
					      <a href="editportfolio.php?a=data&id=' . escape($row->portfolioid) . '" class="btn btn-success btn-xs" data-toggle="tooltip" title="' . $lang['edit'] . '"><span class="fa fa-edit"></span></a>
