...
<html lang="en-US" class="no-js">
 ...
 <body class="skin-green sidebar-mini">
              ...
              <div class="box box-info">
                <div class="box-header">
                  ...
                  <div class="form-group message-reply-container">	
                    <textarea onclick="showMsgButton('. $row->id .')" id="summernote" placeholder="' . $lang['post'] . ' ' . $lang['message'] . '" class="form-control"></textarea>
                  </div>
                    <div id="message_btn_'. $row->id .'" class="comment-btn">
                     <a onclick="postMessage('. $row->id .', '. $freelancer->data()->freelancerid .', '.$clientid.')" class="btn btn-primary">'.$lang[send].' '.$lang[message].' </a>
					</div>
                  </div>
                <div class="box-body">
                	
                  <div id="messages-list'.$row->id.'" class="post-comments" style="overflow-y: scroll; height: 600px; width: 100%;">
                  '.getMessageF($clientid, $freelancer->data()->freelancerid).'
                  </div>
	...
	function postMessage(id, freelancerid, clientid) {
