...
//Redirect URls
$redirectUrls->setReturnUrl('http://localhost/projects/workspace/Kafe-Design/Freelancer/paypal/pay_proposal.php?approved=true')	   
	   ->setCancelUrl('http://localhost/projects/workspace/Kafe-Design/Freelancer/paypal/pay_proposal.php?approved=false');
 ...
 $_SESSION['paypal_hash'] = $hash;
   ...
   $Insert = DB::getInstance()->insert('transactions', array(
	   ...
	   'date_added' => date('Y-m-d H:i:s')
		...
		Session::put("hasError", $proposalid);
